...
; Generated by Chris Rowland on 11/06/2019 (UTC)
;
[Setup]
; GetFileVersion seems to need the full path.
#define AppVer Copy(GetFileVersion("C:\Users\Chris\Documents\Visual Studio 2013\Projects\ASCOM PowerStatus SafetyMonitor\ASCOM PowerStatus SafetyMonitor\bin\Debug\ASCOM.PowerStatus.SafetyMonitor.dll"), 1, 8)
;#define AppNameD "ASCOM Celestron Telescope Driver"
#define AppNameD "ASCOM PowerStatus SafetyMonitor Driver"
...
OutputDir="."
OutputBaseFilename="PowerStatus Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\SafetyMonitor\PowerStatus"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\SafetyMonitor\PowerStatus"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "ASCOM PowerStatus SafetyMonitor\bin\Debug\ASCOM.PowerStatus.SafetyMonitor.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: PowerStatusHelp.pdf; DestDir: {app}; Flags: isreadme; 
; TODO: Add other files needed by your driver here (add subfolders above)

; Only if driver is .NET
[Run]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PowerStatus.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PowerStatus.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64

; Only if driver is .NET
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PowerStatus.SafetyMonitor.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PowerStatus.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PowerStatus.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
